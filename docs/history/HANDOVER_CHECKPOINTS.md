# ARCHIV: průběžné handover checkpointy

> **Historický dokument — nepoužívat jako aktuální instrukce.** Obsah zachycuje
> chronologický průběh vývoje do 2026-09-07, včetně slepých cest, dočasných stavů,
> překonaných hypotéz a položek `Next:`, které už byly dokončeny nebo opuštěny.
> Aktuální stav je v [`../../HANDOVER.md`](../../HANDOVER.md), výsledná architektura
> v [`../ARCHITECTURE.md`](../ARCHITECTURE.md) a vývoj rozhodnutí v
> [`../DECISIONS.md`](../DECISIONS.md).

# Původní obsah: Handover LinkedIn messages reader
